...
async def get_solution(request):
    ...
    pageurl = request.headers['x-pageurl'] #.get['x-pageurl'] #params.get("pageurl")
    secret_key = request.headers["x-secretkey"]
...
splash = """
    ____                  ______      _ __
   / __ \__  __________  / ____/   __(_) /
  / /_/ / / / / ___/ _ \/ __/ | | / / / / 
 / ____/ /_/ / /  /  __/ /___ | |/ / / /  
/_/    \__,_/_/   \___/_____/ |___/_/_/   
